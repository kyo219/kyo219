...
[![numpyro](https://img.shields.io/badge/numpyro-contributor-brightgreen?logo=github)](https://github.com/pyro-ppl/numpyro/pulls?q=is%3Apr%20author%3Akyo219)
- [#2222](https://github.com/pyro-ppl/numpyro/pull/2222) — Avoid unnecessary deepcopy in `random_*_module` and `promote_batch_shape`
<!-- OSS-CONTRIB:END -->
